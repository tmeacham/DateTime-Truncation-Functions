SELECT
/*
THIS SCRIPT WILL CREATE A CALENDAR TABLE WITH THE VALUES DESCRIBED BELOW
...
/****************************************************
This Creates a new table with the values of this script
*****************************************************/
...
ORDER BY
         [FIN].[DateDT];
GO
-- Create a clustered index called IX_Calendar_DateDT  
-- on the dbo.Calendar table using the DateDT column.  
CREATE CLUSTERED INDEX IX_Calendar_DateDT  
    ON dbo.Calendar (DateDT);   
GO  